...
| `IDENTIFIER_SALT`        | The salt used to create identifiers (see [identifiers.md]([identifiers.md]))                                                                                                                                                                                                                                                      |
| `JWT_KEY`                | The private key used to identify the Next.js server to the Convex deployment. Used to sign login messages passed to Convex (see [identifiers.md]([identifiers.md]))                                                                                                                                                               |
| `ADMIN_API_PUBLIC_KEY`   | The public key matching `ADMIN_API_PRIVATE_KEY` in the Convex environment variables. Used to verify admin tokens generated by Convex (see [identifiers.md]([identifiers.md]))                                                                                                                                                     |
