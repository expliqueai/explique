...
export default function CoursePage({ params: { courseSlug, feedbackId } }: FeedbackProps) {
  const user = useQuery(api.courses.getRegistration, { courseSlug });
    ...
    <>
      ...
      <div className="relative p-6 sm:p-10 flex justify-center shadow-[0_-10px_10px_-3px_rgba(0_0_0_/_0.08)]">
        <div className="max-w-6xl flex-1">
          ...
          {built ? <FeedbackPageFunction params={{ courseSlug, feedbackId }} /> : <NoSuperAssistant />}
          <div className="h-10" />
        </div>
      </div>
    </>
...
export const FeedbackPageFunction = ({ params: { courseSlug, feedbackId } }: FeedbackProps) => {
  ...
  useEffect(() => {
  }, [feedback, router, feedbackId, courseSlug]);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-white p-4 rounded-lg shadow">
        <h2 className="text-2xl font-semibold mb-2">Here are some thoughts about your provided solution...</h2>
